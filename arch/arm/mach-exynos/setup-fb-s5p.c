...
#if defined(CONFIG_FB_S5P_WA101S) || defined(CONFIG_FB_S5P_LTE480WV) || defined(CONFIG_FB_S5P_RPLCD)
...
/*
	for (gpio = EXYNOS4_GPF0(0); gpio < EXYNOS4_GPF0(8); gpio++) {
		s3c_gpio_setpull(gpio, S3C_GPIO_PULL_UP);
	}

	for (gpio = EXYNOS4_GPF1(0); gpio < EXYNOS4_GPF1(8); gpio++) {
		s3c_gpio_setpull(gpio, S3C_GPIO_PULL_UP);
	}
	for (gpio = EXYNOS4_GPF2(0); gpio < EXYNOS4_GPF2(8); gpio++) {
		s3c_gpio_setpull(gpio, S3C_GPIO_PULL_UP);
	}
	for (gpio = EXYNOS4_GPF3(0); gpio < EXYNOS4_GPF3(4); gpio++) {
		s3c_gpio_setpull(gpio, S3C_GPIO_PULL_UP);
	}
*/
#endif
...
#if defined(CONFIG_FB_S5P_WA101S)  || defined(CONFIG_FB_S5P_RPLCD)
