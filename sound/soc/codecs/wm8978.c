...
static const u16 wm8978_reg[WM8978_CACHEREGNUM] = {
	...
	0x0033, 0x0090, 0x0090, 0x0100,	/* 0x2c...0x2f */
	0x0100, 0x0002, 0x01e1, 0x01e1,	/* 0x30...0x33 */
	0x0035, 0x0035, 0x0039, 0x0039,	/* 0x34...0x37 */
	0x0001,	0x0001,			              /* 0x38...0x3b */
#endif
	
	0x000,0x1ff,0x1fc,0x1fc,//0x00- 0x03
	0x090,0x000,0x000,0x000,//0x04- 0x07	  
	0x000,0x000,0x000,0x1ff,//0x08-0x0b		
	0x1ff,0x000,0x1ff,0x1ff,//0x0c-0x0f			
	0x1ff,0x000,0x12c,0x02c,//0x10-0x13 	
	0x02c,0x02c,0x02c,0x000,//0x14-0x17 	
	0x032,0x000,0x000,0x000,//0x18-0x1b 	
	0x000,0x000,0x000,0x000,//0x1c-0x1f 	
	0x038,0x00b,0x032,0x008,//0x20-0x23 	
	0x008,0x00c,0x093,0x0e9,//0x24-0x27 	
	0x000,0x000,0x000,0x000,//0x28-0x2b 	
	0x133,0x1bf,0x1bf,0x177,//0x2c-0x2f  	
	0x000,0x00a,0x1e1,0x1e1,//0x30-0x33 	
	0x13f,0x13f,0x135,0x135,//0x34-0x37 
	0x005,0x000,			 //0x38-0x39	  
};
			    ...
			    struct snd_soc_dai *dai)
{
	...
	snd_soc_write(codec,WM8978_POWER_MANAGEMENT_1,0x1fd);
...
MODULE_AUTHOR("Guennadi Liakhovetski ,RongPin LTD");
MODULE_LICENSE("GPL");
