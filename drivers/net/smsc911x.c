...
static irqreturn_t smsc911x_irqhandler(int irq, void *dev_id)
{
	...
	u32 temp;
printk("rongpin smsc911x_irqhandler--------------\r\n");
...
static int __devinit smsc911x_init(struct net_device *dev)
{
	...
	printk("RongPing test byte_test=%x\r\n",byte_test);
...
printk("rongpin test smsc911x-----------222--\r\n");
...
printk("rongpin test smsc911x----------4444444--\r\n");
